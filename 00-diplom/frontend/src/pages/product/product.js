...
const ProductContainer = ({ className }) => {
  ...
  return <div className={className}>{!isCreatingProduct && !isEditingProduct ? <ProductContent product={product} /> : <ProductForm groupId={params.groupId} product={product} />}</div>;
};
